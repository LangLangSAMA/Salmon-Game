...
bool Border::init()
{
    ...
    Vertex vertices[4];
    vertices[0].position = { 50.f, 50.f, -0.01f };
	vertices[0].color = { 1.f, 0.f, 0.f };
    vertices[1].position = { 50.f, hr - 50.f, -0.01f };
	vertices[1].color = { 1.f, 0.f, 0.f };
    vertices[2].position = { wr - 50.f, hr - 50.f, -0.01f };
	vertices[2].color = { 1.f, 0.f, 0.f };
    vertices[3].position = { wr - 50.f, 50.f, -0.01f };
	...
	glBufferData(GL_ELEMENT_ARRAY_BUFFER, sizeof(uint16_t) * 8, indices, GL_STATIC_DRAW);
...
void Border::draw(const mat3& projection)
{
	...
	// Drawing!
	glDrawElements(GL_LINES, 8, GL_UNSIGNED_SHORT, nullptr);
}